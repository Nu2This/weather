...
def forecast(days):
    r = ("http://api.wunderground.com/api/08c90c66a7d001aa/forecast10day/q/MN/"
         "Worthington.json")
...
def radar():
    # radar api string
    r = ('http://api.wunderground.com/api/08c90c66a7d001aa/animatedradar/'
         'q/56119.gif?newmaps=1&radius=200&width=500&height=500&noclutter'
         '=1&timelabel=1&timelabel.y=10')
